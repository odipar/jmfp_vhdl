...
/**
 * Conformance test for {@link Mc68901Idiomatic}: replays
 * {@code tb_feat_mc68901.vcd.zip} and asserts that the idiomatic model
 * produces bit-identical outputs at every rising clock edge in the simulation.
 *
 * <p>This test mirrors {@code Mc68901ConformanceTest} but drives
 * {@link Mc68901Idiomatic} instead of the monolithic {@code Mc68901}, thereby
 * proving that the structured refactoring preserves cycle-accurate correctness.
 *
 ...
 */
class Mc68901IdiomaticConformanceTest {
    ...
    void conformanceTest() throws Exception {
        ...
        System.out.printf("Idiomatic conformance: %d/%d edges OK, %d mismatches%n",
